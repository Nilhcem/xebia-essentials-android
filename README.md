...
This repository contains the source code for the `Xebia Essentials` Android app.

It is available from [Google Play][1].

![Xebia Essentials for Android screenshots][2]

You can also browse the cards from the [Xebia Essentials][3] website.

If you'd like the Xebia Essentials cards for your team, you can get your own deck of Essentials cards in the [Xebia store][4].
...
* Scan your Xebia Essentials cards from everywhere
...
- If you have changed the database model or cards data, upgrade the `AA_DB_VERSION` in the `essentials-android/src/main/AndroidManifest.xml`.
...
The Android source code, excluding cards data (proprietary), is under an Apache 2.0 License:
